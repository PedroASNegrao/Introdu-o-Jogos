...
unordered_map<string, Mix_Music*> Resources::musicTable = *new unordered_map<string, Mix_Music*>;
unordered_map<string, Mix_Chunk*> Resources::soundTable = *new unordered_map<string, Mix_Chunk*>;
